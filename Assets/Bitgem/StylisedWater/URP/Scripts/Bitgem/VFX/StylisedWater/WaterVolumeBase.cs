...
namespace Bitgem.VFX.StylisedWater
{
    ...
    public class WaterVolumeBase : MonoBehaviour
    {
        ...
        {
            // In play mode, runtime-created volumes may not get an OnValidate() call.
            // Flag dirty so Update() (or this method) triggers a rebuild.
            isDirty = true;

            // Ensure a first build when spawned/enabled during gameplay.
